    ...
    <div style={{ background: "black", color: "white", minHeight: "100vh", padding: "40px", fontFamily: "Arial" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "20px", marginTop: "20px" }}>
        <div style={{ border: "1px solid #333", padding: "20px", textAlign: "center" }}>
          ...
          <img src="https://i.imgur.com/8QfKuz1.png" alt="Afnan 9PM Night Out" style={{ height: "120px" }} />
        ...
        <div style={{ border: "1px solid #333", padding: "20px", textAlign: "center" }}>
          <p style={{ color: "gold", fontSize: "12px" }}>LIMITED</p>
          <img src="https://i.imgur.com/Wz4Yx9p.png" alt="Lattafa Asad" style={{ height: "120px" }} />
        ...
        <div style={{ border: "1px solid #333", padding: "20px", textAlign: "center" }}>
          <p style={{ color: "gold", fontSize: "12px" }}>LIMITED</p>
          <img src="https://i.imgur.com/ZK0pYzL.png" alt="Armaf Club de Nuit Intense" style={{ height: "120px" }} />
