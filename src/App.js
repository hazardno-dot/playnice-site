...
const productCopy = {
  "Afnan 9AM": {
    miniTag: "❄️ Fresh / Daily",
    card: "Svež i energičan — citrusi, lavanda i čista drvena baza.",
    modal:
      "Miris čistog starta. Citrusna svežina, blaga lavanda i lagano drvo daju moderan, uredan i veoma nosiv karakter.",
    scentType: "Fresh citrus woody",
    dominantNotes: ["citrusi", "lavanda", "bergamot", "drveni tonovi"],
    tags: ["Fresh", "Daily", "Clean"]
  },

  "Afnan 9PM Rebel": {
    miniTag: "🔥 Bestseller",
    card: "Sladak i zavodljiv — vanila, amber i voćna toplina.",
    modal:
      "Noć koja ne traži dozvolu. Sladak, gust i zavodljiv — vanila i amber nose ceo miris, uz voćni sjaj koji ostaje u vazduhu.",
    scentType: "Sweet amber fruity",
    dominantNotes: ["vanila", "amber", "voćne note", "slatki tonovi"],
    tags: ["Sweet", "Night", "Compliment"]
  },

  "Afnan Supremacy Collector's Edition Pour Homme": {
    miniTag: "💎 Luxury / Signature",
    card: "Voćno-dimni luksuz — ananas, dim i mošus.",
    modal:
      "Smela elegancija sa karakterom. Sočan ananas, suptilan dim i čista mošusna dubina daju skup i upečatljiv trag.",
    scentType: "Fruity smoky musky",
    dominantNotes: ["ananas", "dim", "mošus", "drveni tonovi"],
    tags: ["Luxury", "Signature", "Bold"]
  },

  "Afnan Turathi Blue": {
    miniTag: "🔥 Bestseller",
    card: "Citrusno-aromatičan — bergamot, amber i elegantno drvo.",
    modal:
      "Svežina sa ozbiljnim karakterom. Bergamot otvara miris svetlo i čisto, dok amber i drvo daju dubinu i trajnost.",
    scentType: "Citrus aromatic amber",
    dominantNotes: ["bergamot", "citrusi", "amber", "drveni tonovi"],
    tags: ["Fresh", "Elegant", "Versatile"]
  },

  "Arabiyat Prestige Marwa": {
    miniTag: "💎 Luxury / Signature",
    card: "Orijentalan i raskošan — ruža, slatki začini i topla baza.",
    modal:
      "Bogata orijentalna elegancija. Predivan miris ruže i toplih začina otvara luksuzan, zavodljiv i veoma upečatljiv trag.",
    scentType: "Oriental floral spicy",
    dominantNotes: ["ruža", "slatki začini", "amber", "topli tonovi"],
    tags: ["Oriental", "Rose", "Luxury"]
  },

  "Armaf Club De Nuit Bling": {
    miniTag: "🍯 Sweet / Date Night",
    card: "Sladak i glamurozan — voće, ruža i meka vanila.",
    modal:
      "Sjaj koji privlači pažnju. Voćna slatkoća, ruža i kremasta vanila daju moderan, blistav i vrlo primetan miris.",
    scentType: "Fruity floral sweet",
    dominantNotes: ["voćne note", "ruža", "vanila", "slatki tonovi"],
    tags: ["Sweet", "Floral", "Attention"]
  },

  "Armaf Club de Nuit Intense": {
    miniTag: "🔥 Bestseller",
    card: "Oštar i dimno-citrusan — limun, dim i tamno drvo.",
    modal:
      "Prvi utisak koji ostaje. Oštar citrusni opening brzo prelazi u dimnu, muževnu i veoma prepoznatljivu dubinu.",
    scentType: "Citrus smoky woody",
    dominantNotes: ["limun", "citrusi", "dim", "drveni tonovi"],
    tags: ["Bold", "Signature", "Night"]
  },

  "Armaf Club de Nuit Sillage": {
    miniTag: "❄️ Fresh / Daily",
    card: "Metalno-svež — citrusi, mošus i hladni cvetni tonovi.",
    modal:
      "Hladna elegancija sa potpisom. Citrusna čistina, mošus i metalno-svež karakter daju sofisticiran i drugačiji miris.",
    scentType: "Fresh musky metallic",
    dominantNotes: ["citrusi", "mošus", "hladni cvetni tonovi", "drveni tonovi"],
    tags: ["Fresh", "Elegant", "Unique"]
  },

  "French Avenue Vulcan Sable by Fragrance World": {
    miniTag: "💎 Luxury / Signature",
    card: "Topao i taman — začini, amber i duboka drvena baza.",
    modal:
      "Miris sa mračnim luksuzom. Topli začini, amber i tamno drvo daju bogat, skup i ozbiljno zavodljiv karakter.",
    scentType: "Warm spicy amber woody",
    dominantNotes: ["začini", "amber", "drveni tonovi", "tamni akordi"],
    tags: ["Luxury", "Dark", "Evening"]
  },

  "Haramain Signature Blue": {
    miniTag: "❄️ Fresh / Daily",
    card: "Čist i svetao — citrusi, aromatične note i lagano drvo.",
    modal:
      "Lako nosiva svežina za svaki dan. Citrusni i aromatični tonovi daju čist, prijatan i uredan utisak.",
    scentType: "Fresh aromatic citrus",
    dominantNotes: ["citrusi", "aromatične note", "lagano drvo", "čisti tonovi"],
    tags: ["Fresh", "Daily", "Easy"]
  },

  "Khadlaj Island Dreams Extrait de Parfum": {
    miniTag: "🔥 Bestseller",
    card: "Letnji i zarazan — tropsko voće, kremasti tonovi i sunčana svežina.",
    modal:
      "Miris odmora na koži. Tropsko voće i mekani kremasti akordi daju srećan, lagan i veoma privlačan letnji vibe.",
    scentType: "Tropical fruity creamy",
    dominantNotes: ["tropsko voće", "kremasti tonovi", "slatke note", "sveži akordi"],
    tags: ["Summer", "Tropical", "Easy"]
  },

  "Lattafa Asad Elixir": {
    miniTag: "🔥 Bestseller",
    card: "Sladak i začinski — vanila, amber i toplo drvo.",
    modal:
      "Tamna slatkoća sa snagom. Vanila, amber i začini stvaraju gust, moćan i vrlo privlačan večernji miris.",
    scentType: "Sweet spicy amber",
    dominantNotes: ["vanila", "amber", "začini", "drveni tonovi"],
    tags: ["Sweet", "Bold", "Night"]
  },

  "Lattafa Fakhar Black": {
    miniTag: "❄️ Fresh / Daily",
    card: "Aromatično svež — jabuka, lavanda i elegantna drvena baza.",
    modal:
      "Čist, moderan i veoma nosiv. Sveža jabuka i lavanda otvaraju miris svetlo, dok drvena baza daje muževan finiš.",
    scentType: "Aromatic fresh woody",
    dominantNotes: ["jabuka", "lavanda", "citrusi", "drveni tonovi"],
    tags: ["Fresh", "Modern", "Versatile"]
  },

  "Lattafa Khamrah Qahwa": {
    miniTag: "🔥 Bestseller",
    card: "Topao i sladak — kafa, cimet i kremasta vanila.",
    modal:
      "Zavodljiva toplina u punom sjaju. Bogata kafa, cimet i vanila stvaraju gust, sladak i addictive trag.",
    scentType: "Gourmand coffee spicy",
    dominantNotes: ["kafa", "cimet", "vanila", "slatki začini"],
    tags: ["Gourmand", "Sweet", "Winter"]
  },

  "Lattafa Musamam Black Intense": {
    miniTag: "💎 Luxury / Signature",
    card: "Tamno i luksuzno — začini, dim i bogato drvo.",
    modal:
      "Dubok i ozbiljan miris sa orijentalnim potpisom. Začini, dimni tonovi i bogata drvena baza daju snažan karakter.",
    scentType: "Dark spicy woody",
    dominantNotes: ["začini", "dim", "drveni tonovi", "amber"],
    tags: ["Dark", "Luxury", "Evening"]
  },

  "Lattafa Qaed Al Fursan Untamed": {
    miniTag: "🍯 Sweet / Date Night",
    card: "Voćno-dimni twist — ananas, začini i topla baza.",
    modal:
      "Sočno, smelo i upečatljivo. Voćni opening sa ananasom prelazi u začinsku toplinu i snažan orijentalni trag.",
    scentType: "Fruity spicy smoky",
    dominantNotes: ["ananas", "začini", "dim", "topli tonovi"],
    tags: ["Bold", "Sweet", "Exotic"]
  },

  "Paris Corner Emir Trillium": {
    miniTag: "❄️ Fresh / Daily",
    card: "Čisto i moderno — citrusi, aromatične note i svetlo drvo.",
    modal:
      "Miris urednosti i lakoće. Citrusna i aromatična svežina sa svetlom drvenom bazom čini ga veoma nosivim.",
    scentType: "Fresh aromatic woody",
    dominantNotes: ["citrusi", "aromatične note", "drveni tonovi", "čisti akordi"],
    tags: ["Fresh", "Clean", "Daily"]
  },

  "Paris Corner Emir Voux Elegante": {
    miniTag: "💎 Luxury / Signature",
    card: "Elegantno kremast — začini, cvetni tonovi i meko drvo.",
    modal:
      "Sofisticiran i uglađen. Kremasti začinski tonovi i meka drvena osnova daju elegantan, fin i luksuzan utisak.",
    scentType: "Elegant spicy woody",
    dominantNotes: ["začini", "cvetni tonovi", "drveni tonovi", "meki akordi"],
    tags: ["Elegant", "Luxury", "Refined"]
  },

  "Paris Corner Ministry of Oud - Oud Satin": {
    miniTag: "💎 Luxury / Signature",
    card: "Baršunast i raskošan — oud, ruža i slatka toplina.",
    modal:
      "Luksuz sa orijentalnim potpisom. Oud i ruža u baršunastoj, slatko-toploj bazi daju bogat i skup utisak.",
    scentType: "Oud rose oriental",
    dominantNotes: ["oud", "ruža", "slatki tonovi", "amber"],
    tags: ["Oud", "Luxury", "Signature"]
  },

  "Paris Corner Perfumes North Stag Expressions II DEUX": {
    miniTag: "❄️ Fresh / Daily",
    card: "Svetao i energičan — citrusi, đumbir i čisto drvo.",
    modal:
      "Pun energije i kretanja. Citrusi i nota đumbira daju živ start, dok drvena osnova drži miris elegantnim.",
    scentType: "Citrus spicy woody",
    dominantNotes: ["citrusi", "đumbir", "drveni tonovi", "aromatične note"],
    tags: ["Fresh", "Energetic", "Modern"]
  },

  "Rayhaan Aquatica": {
    miniTag: "❄️ Fresh / Daily",
    card: "Vodeno svež — morski tonovi, citrusi i čista baza.",
    modal:
      "Miris hladne svežine i lakoće. Morski akordi i citrusi daju osećaj čiste, prozračne i letnje energije.",
    scentType: "Aquatic fresh citrus",
    dominantNotes: ["morski tonovi", "citrusi", "čisti akordi", "lagano drvo"],
    tags: ["Aquatic", "Fresh", "Summer"]
  },

  "Rayhaan Pacific Aura": {
    miniTag: "❄️ Fresh / Daily",
    card: "Pacifički svež — voćni citrusi, morski tonovi i lagana toplina.",
    modal:
      "Letnji miris sa vedrim karakterom. Sveži voćni tonovi i morska prozračnost stvaraju čist i privlačan trag.",
    scentType: "Fresh aquatic fruity",
    dominantNotes: ["morski tonovi", "voćne note", "citrusi", "čisti tonovi"],
    tags: ["Summer", "Fresh", "Easy"]
  },

  "Swiss Arabian Tobacco 01 Extrait de Parfum": {
    miniTag: "💎 Luxury / Signature",
    card: "Bogat i sladak — duvan, med i topli začini.",
    modal:
      "Teška elegancija sa toplinom. Duvan, med i začini grade gust, luksuzan i duboko privlačan miris.",
    scentType: "Tobacco sweet spicy",
    dominantNotes: ["duvan", "med", "začini", "topli akordi"],
    tags: ["Tobacco", "Rich", "Evening"]
  },

  "Acqua di Parma Blu Mediterraneo Fico di Amalfi Eau de Toilette": {
    miniTag: "❄️ Fresh / Daily",
    card: "Mediteranski svež — smokva, citrusi i nežni zeleni tonovi.",
    modal:
      "Miris sunčanog juga. Smokva i citrusi daju lagan, prirodan i elegantan letnji karakter pun lakoće.",
    scentType: "Fresh fruity citrus",
    dominantNotes: ["smokva", "citrusi", "zeleni tonovi", "lagana baza"],
    tags: ["Fresh", "Summer", "Elegant"]
  },

  "Acqua di Parma Colonia Essenza Eau de Cologne": {
    miniTag: "💎 Luxury / Signature",
    card: "Klasično elegantan — citrusi, neroli i čista drvena baza.",
    modal:
      "Italijanska elegancija u čistom obliku. Svetli citrusi, neroli i besprekorna baza daju sofisticiran i bezvremenski utisak.",
    scentType: "Classic citrus aromatic",
    dominantNotes: ["citrusi", "neroli", "aromatične note", "drveni tonovi"],
    tags: ["Classic", "Elegant", "Refined"]
  },

  "Acqua di Parma Colonia Pura Eau de Cologne": {
    miniTag: "❄️ Fresh / Daily",
    card: "Čisto i sofisticirano — bergamot, citrusi i beli mošus.",
    modal:
      "Svežina koja izgleda skupo. Bergamot, čisti citrusi i beli mošus stvaraju uredan, lagan i luksuzan trag.",
    scentType: "Fresh citrus musky",
    dominantNotes: ["bergamot", "citrusi", "beli mošus", "aromatične note"],
    tags: ["Fresh", "Clean", "Luxury"]
  },

  "BLEU DE CHANEL Eau de Parfum Spray": {
    miniTag: "🔥 Bestseller",
    card: "Čist i elegantan — citrusi, tamjan i tamno drvo.",
    modal:
      "Sigurnost bez potrebe za dokazivanjem. Citrusna svežina, tamjan i drvena dubina daju autoritet, stil i trajnost.",
    scentType: "Citrus incense woody",
    dominantNotes: ["citrusi", "tamjan", "grejpfrut", "drveni tonovi"],
    tags: ["Classic", "Elegant", "Signature"]
  },

  "Bois Impérial by Essential Parfums": {
    miniTag: "🔥 Bestseller",
    card: "Moderno zelen — bosiljak, začini i sofisticirano drvo.",
    modal:
      "Miris koji deluje nišno i savremeno. Zeleni, začinski i drveni tonovi daju čist, elegantan i vrlo prepoznatljiv profil.",
    scentType: "Green woody spicy",
    dominantNotes: ["zeleni tonovi", "bosiljak", "začini", "drveni tonovi"],
    tags: ["Niche", "Modern", "Signature"]
  },

  "BOSS Bottled Beyond Eau de Parfum": {
    miniTag: "🍯 Sweet / Date Night",
    card: "Topao i moderan — začini, drvo i slatka muževnost.",
    modal:
      "Savremen boss vibe. Začinski tonovi i drvena toplina daju uredan, privlačan i lako dopadljiv karakter.",
    scentType: "Warm spicy woody",
    dominantNotes: ["začini", "drveni tonovi", "slatki akordi", "amber"],
    tags: ["Modern", "Warm", "Versatile"]
  },

  "BOSS The Scent Elixir Parfum Intense for Him": {
    miniTag: "🍯 Sweet / Date Night",
    card: "Topao i senzualan — amber, začini i intenzivno drvo.",
    modal:
      "Privlačnost u najčišćem obliku. Topao amber, začinska dubina i bogata baza stvaraju magnetičan večernji trag.",
    scentType: "Amber spicy woody",
    dominantNotes: ["amber", "začini", "drveni tonovi", "topli akordi"],
    tags: ["Night", "Sensual", "Intense"]
  },

  "BOSS The Scent Le Parfum for Him": {
    miniTag: "🍯 Sweet / Date Night",
    card: "Zavodljiv i topao — iris, začini i bogata baza.",
    modal:
      "Mekši i elegantniji tip zavodljivosti. Iris i začinska toplina daju sofisticiran, topao i veoma prijatan miris.",
    scentType: "Warm spicy powdery",
    dominantNotes: ["iris", "začini", "amber", "drveni tonovi"],
    tags: ["Elegant", "Date Night", "Warm"]
  },

  "Calvin Klein CK All Eau de Toilette": {
    miniTag: "❄️ Fresh / Daily",
    card: "Univerzalno svež — citrusi i beli mošus.",
    modal:
      "Čista svakodnevica. Lagani citrusi i beli mošus daju mekan, čist i prijatan miris koji ide uz sve.",
    scentType: "Fresh musky citrus",
    dominantNotes: ["citrusi", "beli mošus", "mandarina", "čisti akordi"],
    tags: ["Fresh", "Daily", "Soft"]
  },

  "Calvin Klein Defy Eau de Toilette": {
    miniTag: "❄️ Fresh / Daily",
    card: "Svež i čist — citrusi, lavanda i vetiver.",
    modal:
      "Moderan minimalizam sa muževnim finišem. Citrusna svežina i lavanda prelaze u čist vetiver i drvenu bazu.",
    scentType: "Fresh aromatic woody",
    dominantNotes: ["citrusi", "lavanda", "vetiver", "drveni tonovi"],
    tags: ["Fresh", "Daily", "Clean"]
  },

  "Calvin Klein Defy Parfum": {
    miniTag: "💎 Luxury / Signature",
    card: "Dublji i topliji — amber, lavanda i elegantno drvo.",
    modal:
      "Intenzivnija verzija svežine. Amber i lavanda u bogatijoj drvenoj bazi daju ozbiljniji, topliji i sofisticiran karakter.",
    scentType: "Amber aromatic woody",
    dominantNotes: ["amber", "lavanda", "drveni tonovi", "topli akordi"],
    tags: ["Elegant", "Modern", "Versatile"]
  },

  "Chopard Oud Malaki Eau de Parfum": {
    miniTag: "💎 Luxury / Signature",
    card: "Raskošan i taman — oud, začini i topla amber dubina.",
    modal:
      "Luksuzan oud sa klasičnim karakterom. Začini i amber omekšavaju tamnu dubinu i daju skup, ozbiljan trag.",
    scentType: "Oud spicy amber",
    dominantNotes: ["oud", "začini", "amber", "drveni tonovi"],
    tags: ["Oud", "Luxury", "Evening"]
  },

  "Creed Aventus Cologne": {
    miniTag: "🔥 Bestseller",
    card: "Elegantno svež — citrusi, đumbir i vetiver.",
    modal:
      "Tihi luksuz bez buke. Citrusna svetlost i nota đumbira spajaju se sa vetiverom u čist, moćan i sofisticiran miris.",
    scentType: "Citrus spicy woody",
    dominantNotes: ["citrusi", "đumbir", "vetiver", "mandarina"],
    tags: ["Luxury", "Fresh", "Refined"]
  },

  "Giorgio Armani Acqua di Giò Profondo Parfum": {
    miniTag: "🔥 Bestseller",
    card: "Duboko svež — morski tonovi, bergamot i mineralna baza.",
    modal:
      "Svežina sa dubinom i ozbiljnošću. Morski akordi, bergamot i mineralna baza daju moderan i veoma čist muški potpis.",
    scentType: "Aquatic aromatic fresh",
    dominantNotes: ["morski tonovi", "bergamot", "mineralni tonovi", "aromatične note"],
    tags: ["Aquatic", "Fresh", "Signature"]
  },

  "Gisada Ambassador Men Eau de Parfum": {
    miniTag: "🔥 Bestseller",
    card: "Topao i sladak — voće, vanila i amber.",
    modal:
      "Ulazak koji svi primete. Voćna slatkoća, amber i vanila daju harizmu, toplinu i mnogo komplimenata.",
    scentType: "Fruity sweet amber",
    dominantNotes: ["voćne note", "vanila", "amber", "slatki tonovi"],
    tags: ["Compliment", "Sweet", "Popular"]
  },

  "Givenchy Gentleman Eau de Parfum Réserve Privée": {
    miniTag: "💎 Luxury / Signature",
    card: "Topao i sofisticiran — viski, iris i tamno drvo.",
    modal:
      "Elegantna dubina sa karakterom. Kremasti iris i viski akord stvaraju luksuzan, mekan i veoma zavodljiv utisak.",
    scentType: "Boozy powdery woody",
    dominantNotes: ["viski", "iris", "drveni tonovi", "topli akordi"],
    tags: ["Elegant", "Luxury", "Evening"]
  },

  "Jimmy Choo Man Blue Eau de Toilette": {
    miniTag: "❄️ Fresh / Daily",
    card: "Ležerno svež — aromatične note, crni biber i sivo drvo.",
    modal:
      "Opušten, moderan i lak za nošenje. Aromatična svežina sa začinskim dodirom daje urban i prijatan karakter.",
    scentType: "Fresh spicy aromatic",
    dominantNotes: ["aromatične note", "crni biber", "drveni tonovi", "lavanda"],
    tags: ["Fresh", "Casual", "Easy"]
  },

  "L'Homme Eau de Parfum by Yves Saint Laurent": {
    miniTag: "💎 Luxury / Signature",
    card: "Elegantno zavodljiv — začini, lavanda i sofisticirano drvo.",
    modal:
      "Miris doteranog samopouzdanja. Začini i lavanda otvaraju elegantno, dok drvena toplina daje ozbiljnu sofisticiranost.",
    scentType: "Spicy aromatic woody",
    dominantNotes: ["začini", "lavanda", "drveni tonovi", "amber"],
    tags: ["Elegant", "Refined", "Date Night"]
  },

  "L'Homme Idéal De Guerlain Paris Eau De Toilette": {
    miniTag: "💎 Luxury / Signature",
    card: "Chic i drugačiji — badem, citrusi i toplo drvo.",
    modal:
      "Francuska elegancija sa karakterom. Badem daje poseban potpis, dok citrusi i drvo održavaju miris elegantnim i modernim.",
    scentType: "Almond citrus woody",
    dominantNotes: ["badem", "citrusi", "drveni tonovi", "začini"],
    tags: ["Elegant", "Unique", "Refined"]
  },

  "Mancera Cedrat Boise Eau de Parfum": {
    miniTag: "🔥 Bestseller",
    card: "Citrusno-drveni luksuz — limun, voćna svežina i kremasto drvo.",
    modal:
      "Energija uspeha u bočici. Svetao citrusni opening, voćna slatkoća i kremasta drvena baza daju luksuz bez napora.",
    scentType: "Citrus fruity woody",
    dominantNotes: ["limun", "voćne note", "drveni tonovi", "vanila"],
    tags: ["Luxury", "Fresh", "Signature"]
  },

  "Montblanc Explorer Extreme Parfum": {
    miniTag: "💎 Luxury / Signature",
    card: "Avanturistički i dubok — citrusi, pačuli i snažno drvo.",
    modal:
      "Miris kretanja, samopouzdanja i modernog muškog stila. Citrusna svežina prelazi u zemljani pačuli i moćnu drvenu bazu.",
    scentType: "Citrus earthy woody",
    dominantNotes: ["citrusi", "pačuli", "drveni tonovi", "zemljani akordi"],
    tags: ["Masculine", "Modern", "Versatile"]
  },

  "Narciso Rodriguez for Him Bleu Noir Eau de Parfum": {
    miniTag: "💎 Luxury / Signature",
    card: "Misteriozan i čist — mošus, iris i tamna elegancija.",
    modal:
      "Diskretan, ali veoma sofisticiran. Mošus i iris daju čist, taman i zavodljivo elegantan potpis.",
    scentType: "Musky powdery woody",
    dominantNotes: ["mošus", "iris", "drveni tonovi", "začinski tonovi"],
    tags: ["Elegant", "Dark", "Refined"]
  },

  "Terre d'Hermès Eau de Toilette": {
    miniTag: "💎 Luxury / Signature",
    card: "Suvo elegantan — narandža, vetiver i mineralno drvo.",
    modal:
      "Miris karaktera i stava. Narandža, vetiver i mineralna suvoća daju jedinstven, ozbiljan i bezvremenski potpis.",
    scentType: "Citrus earthy woody",
    dominantNotes: ["narandža", "vetiver", "mineralni tonovi", "drveni tonovi"],
    tags: ["Classic", "Refined", "Signature"]
  },

  "Tom Ford Noir Extreme Eau de Parfum": {
    miniTag: "🍯 Sweet / Date Night",
    card: "Bogato i zavodljivo — kardamom, vanila i kremasti amber.",
    modal:
      "Večernji luksuz u punom sjaju. Začinski opening, kremasta vanila i topli amber daju senzualan i veoma bogat trag.",
    scentType: "Sweet spicy amber",
