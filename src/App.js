...
/* feedback helper */
  ...
  try {
    await fetch("https://script.google.com/macros/s/AKfycbwnmROzxz_ym4B6bdjc1dc6EHcXsbC5JghA1C1cNcj50Q5p8RXAh0gHs3VNxh4E0lvsYA/exec", {
      method: "POST",
      headers: {
  ...
  👎
            ...
            <div
              className={`journal-feedback-inline-shell ${
                journalFeedbackSubmitted ? "is-success" : ""
              }`}
            >
