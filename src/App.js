...
const productCopy = {
  ...
  "Afnan Supremacy Collector's Edition Pour Homme": {
    ...
    whyChoose: {
      sr: "Za one koji žele ozbiljan signature miris.",
  ...
  "Armaf Club De Nuit Bling": {
    ...
    modal: {
      sr: "Upadljiv i zavodljiv — pravi party miris.",
  ...
  "Armaf Club de Nuit Intense": {
    ...
    modal: {
      sr: "Snažan i prepoznatljiv — pravi statement miris.",
  ...
  "Khadlaj Island Dreams Extrait de Parfum": {
    miniTag: { sr: "🔥 Bestseller", en: "🔥 Bestseller" },
    card: {
      sr: "Tropski, sladak i letnji vibe.",
  ...
  "Afnan 9PM Night Out": {
    ...
    tags: {
      sr: ["Night out", "Komplimenti", "Hladnije vreme"],
  ...
  "Rasasi Hawas Ice for Him": {
    ...
    dominantNotes: {
      sr: ["aquatic note", "voće", "ambergris", "mošus"],
      en: ["aquatic notes", "fruits", "ambergris", "musk"]
    },
    tags: {
      sr: ["Summer", "Daily", "Fresh", "Komplimenti"],
...
Three people at the same table. Quiet. Not awkward, not tense — just… silence. Each one looking at their own phone. Everyone seemed to be somewhere.
Just not there.
...
Then I caught myself. Same thing. Phone in hand. Thumb moving. Head… somewhere in between.
...
Maybe that is the only thing worth trying tonight. Not to use your phone less. Just to see what is left when you are not looking at it.
...
Za istim stolom — troje ljudi. Tišina. Ne neprijatna, ne napeta — samo… ćute. Svako gleda u svoj telefon. Svi deluju kao da su negde.
Ali niko nije tu.
Konobar prolazi, nosi piće, malo zakači stolicu. Niko ne podiže pogled.
Jedan momak se nasmeje. Ne zato što se nešto desilo tu — nego negde drugde.

I onda uhvatim sebe. Isto. Telefon u ruci. Palac radi. Glava… negde između.
...
Danas je normalna. Čak i prijatna. Niko te ne pita ništa. Niko ne traži pažnju. Svi su “zauzeti”.
...
Možda je to jedina stvar koju vredi probati večeras. Ne da manje koristiš telefon. Nego da vidiš šta ostane kad ga ne gledaš.
...
const getSizeWearHint = (size) => {
  ...
  <>
    <section
      className="shop-value-anchor section-wrap"
      aria-label="Why try before you buy"
    >
  ...
  <h3>
    {lang === "sr"
      ...
      <>
        <div
          className={`how-it-works-overlay ${howItWorksOpen ? "open" : ""}`}
          ...
          <div className="how-it-works-drawer-body">
            ...
            <div className="how-it-works-drawer-grid">
              ...
              <div className="how-it-works-drawer-card panel-item-anim panel-item-4">
                <h4>
                  {lang === "sr" ? "Originalni parfemi" : "Original fragrances"}
                </h4>
                <p>
                  {lang === "sr"
