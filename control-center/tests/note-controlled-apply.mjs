...
for (const token of ["approved_payload", "source_sha", "LIVE DRIFT", "playnice-site/public/note-map", "playnice-site/src/features/note-map/TheNoteMapImpl.jsx", "draft: true", "apply_branch", "apply_pr_number"]) {
