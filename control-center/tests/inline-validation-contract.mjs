...
const baseFields = [
  ...
  { name: "Moods · comma separated", value: "clean, signature, soft", type: "text" },
  ...
  { name: "Dominant notes · SR", value: "bergamot, ginger, moss, amber", type: "text" },
  { name: "Dominant notes · EN", value: "bergamot, ginger, moss, amber", type: "text" },
  { name: "Tags · SR", value: "clean, fresh, modern", type: "text" },
  { name: "Tags · EN", value: "clean, fresh, modern", type: "text" },
