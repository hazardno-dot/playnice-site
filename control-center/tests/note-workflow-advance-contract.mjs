...
if (!route.includes('import handler from "./create-note-apply.cjs"') || !route.includes("export default handler")) {
...
console.log("PASS  Notes apply route uses an ESM-safe CommonJS boundary");
