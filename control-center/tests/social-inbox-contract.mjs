...
const syncApi = fs.readFileSync(path.join(root, "control-center/server/social-inbox-sync.js"), "utf8");
const replyApi = fs.readFileSync(path.join(root, "control-center/server/social-inbox-reply.js"), "utf8");
const webhookApi = fs.readFileSync(path.join(root, "control-center/server/social-inbox-webhook.js"), "utf8");
const webhookManageApi = fs.readFileSync(path.join(root, "control-center/server/social-inbox-webhook-manage.js"), "utf8");
