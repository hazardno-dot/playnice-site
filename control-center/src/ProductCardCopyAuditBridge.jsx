  ...
  return <section className="card-copy-audit-panel">
    <div className="card-copy-audit-head">
      <div>
        ...
        <p>Audits the live SR/EN Card Copy against the desktop two-line contract. Character count is secondary; rendered fit is the authority.</p>
      </div>
    ...
    {!fontReady ? <div className="card-copy-audit-loading">Loading storefront font metrics…</div> : <>
      ...
      <div className="card-copy-audit-note">
        <strong>Authority:</strong> 32ch is the live desktop Card Copy contract. The 28/30/34ch figures are comparison references only; card dimensions, font, font size and two-line height are unchanged.
      </div>
