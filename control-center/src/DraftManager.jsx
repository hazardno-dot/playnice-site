...
function buildChanges(live, draft) {
  ...
  ["sr", "en"].forEach((lang) => pushChange(changes, "Do Not Wear", lang.toUpperCase(), liveDoNotWear?.[lang] || "", draftDoNotWear?.[lang] || ""));
  const liveWhatToWear = productWhatToWearContext[live.name] || {}, draftWhatToWear = draft.whatToWear || {};
  ["sr", "en"].forEach((lang) => pushChange(changes, "What To Wear", lang.toUpperCase(), liveWhatToWear?.[lang] || "", draftWhatToWear?.[lang] || ""));
