...
describe("FI Knowledge — entity routing", () => {
  ...
  test.each([
    ...
    ["Šta znači beast mode parfem?", "beast-mode"],
    ["Šta je signature scent?", "signature-scent"],
    ["Šta znači dumb reach?", "dumb-reach"],
    ["Šta je blue fragrance?", "blue-fragrance"],
    ["Šta znači freshie?", "freshie"],
    ["Šta je compliment getter?", "compliment-getter"],
    ["Šta znači office safe parfem?", "office-safe"],
    ["Šta je batch variation?", "batch-variation"],
    ["Šta je steam distillation?", "steam-distillation"],
    ["Šta je hladno ceđenje citrusa?", "expression"],
    ["Šta je solvent extraction?", "solvent-extraction"],
    ["Šta je absolute u parfimeriji?", "absolute"],
    ["Šta je etarsko ulje?", "essential-oil"],
    ["Šta je CO2 ekstrakcija?", "co2-extraction"],
    ["Šta je headspace technology?", "headspace"],
    ["Šta je enfleurage?", "enfleurage"],
    ["Šta je captive molecule?", "captive-material"],
    ["Šta je parfemska tinktura?", "tincture"],
    ["Šta je perfume oil?", "perfume-oil"],
    ["Šta je attar?", "attar-itr"],
    ["Šta radi alkohol u parfemu?", "ethanol-role"],
    ["Šta je razblaživanje parfema?", "fragrance-dilution"],
    ["Da li EDP traje duže od EDT?", "concentration-performance-myth"],
    ["Da li Extrait najviše projektuje?", "extrait-projection"],
    ["Šta je parfem bez alkohola?", "alcohol-free"],
    ["Šta je razlika između vanile i vanilina?", "vanilla-vanillin"],
    ["Šta je sandalovina u parfemu?", "sandalwood"],
    ["Šta je cedar note?", "cedarwood"],
    ["Šta je oakmoss?", "oakmoss"],
    ["Šta znači rose note?", "rose"],
    ["Šta je jasmin u parfemu?", "jasmine"],
    ["Šta je tuberoza?", "tuberose"],
    ["Šta su ionones?", "violet-ionones"],
    ["Šta je heliotropin?", "heliotrope-heliotropin"],
    ["Šta je ambrette seed?", "ambrette"],
    ["Šta je petitgrain?", "petitgrain"],
    ["Šta je galbanum?", "galbanum"],
    ["Šta je mirra u parfemu?", "myrrh"],
    ["Šta je elemi?", "elemi"],
