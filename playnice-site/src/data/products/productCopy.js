...
export const productCopy = {
  ...
  card: {
    sr: "Sočan ananas, mahovina i amber u snažnom modernom profilu.",
    en: "Juicy pineapple, oakmoss and amber in a bold modern profile."
  },

  modal: {
    sr: "Ananas, citrusi i kristalna svežina prelaze u šljivu, mahovinu i toplu amber-tonka bazu.",
    en: "Pineapple, citrus and crystalline freshness settle into plum, oakmoss and a warm amber-tonka base."
  },
  ...
  dominantNotes: {
    sr: ["ananas", "hrastova mahovina", "šljiva", "tonka"],
    en: ["pineapple", "oakmoss", "plum", "tonka bean"]
  },
...
"Narciso Rodriguez for Him Bleu Noir Eau de Toilette Extreme": {
  ...
  "Thomas Kosmala No. 8 Tonic Vert Eau de Parfum": {
    ...
    "card": {
      ...
      "sr": "Svjež citrusni start prelazi u hladnu mentu i čistu zelenu bazu vetivera i mahovine. Tonic Vert je uredan, energičan i vrlo lak za nošenje."
    },
    "modal": {
      ...
      "sr": "No. 8 Tonic Vert otvara se eksplozijom bergamota, limuna, mandarine i limete, a zatim prelazi u svježinu mente, geranijuma i pomela. Vetiver, mošus i hrastova mahovina u bazi daju mu suvu, čistu i elegantno zelenu završnicu.\n\nOvo nije sladak citrusni parfem. Više je hladan, precizan i aromatičan — odličan izbor za tople dane, kancelariju i trenutke kada želiš da mirišeš čisto bez generičnog “blue fragrance” utiska."
    },
    "scentType": {
    ...
    "whyChoose": {
      ...
      "sr": "Ako voliš svježe parfeme, ali želiš više zelenila, suvoće i karaktera."
    }
  }
};
